...
function validateSignupForm() {
    ...
    if (!password.value.trim()) {
        ...
        showError('signup-password-error', 'Password must contain uppercase, lowercase, and numbers');
        isValid = false;
    } else {
        password.classList.add('success');
    }
...
function handleSocialLogin(e) {
    e.preventDefault();
    const provider = e.target.classList.contains('google-btn') ? 'Google' : 'Apple';
